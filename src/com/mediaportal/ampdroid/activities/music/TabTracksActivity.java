         ...
         if (values != null) {
            ...
            if (items != null) {
               for (MusicTrack t : items) {
                  mAdapter.addItem(ViewTypes.TextView.ordinal(), new MusicTrackTextViewAdapterItem(t, true));
                  mAdapter
                        .addItem(ViewTypes.ThumbView.ordinal(), new MusicTrackThumbViewAdapterItem(t, true));
               }
            } else {
